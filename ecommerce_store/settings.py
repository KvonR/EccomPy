...
LOGIN_REDIRECT_URL = '/products/'  # Redirect to products page after login
LOGOUT_REDIRECT_URL = '/products/'  # Redirect to products page after logout
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'product/templates'],  # Add your templates directory here
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
